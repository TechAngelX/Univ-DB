...
@WebServlet("/DeptChoicesServlet")
public class DeptChoicesServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        InputStream inputStream = getServletContext().getResourceAsStream("/json/deptChoices.json");
        if (inputStream == null) {
